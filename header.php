...
<nav id="menuMobile" class="menuMobile header without--sidebar">
	...
	<ul id="navbarMobile" class="navbarMobile">
		<li><a href=".php">Buy</a></li><li><a href=".php" >Rent</a></li><li><a href=".php">Sale</a></li><li><a href="#contact">Contact us</a></li><li><a href="myaccount.php" class="account"><img src="images/account.png"></a></li><li><a href="logout.php">Log-out</a></li>
	</ul> 
</nav>
